        ...
        <div className={classes.latar}  >
            <div className={classes.navbar}>
                <ul className={classes.nav}>
                    <li className={classes.subnav}><Link to="/" style={{ textDecoration: 'none', color: 'black' }}>Home</Link></li>
                    ...
                    <li className={classes.subnav}></li>
                    <li className={classes.subnav}></li>
                    <li className={classes.subnav}> About</li>
                    <li className={classes.subnav}> Skill</li>
                    <li className={classes.subnav}> Portofolio</li>
                    <li className={classes.subnav}> Contact</li>
                    <li className={classes.subnav}></li>
                </ul>
                <hr></hr>
            </div>
