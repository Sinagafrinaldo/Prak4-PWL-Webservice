    ...
    return (
        <div className={classes.latar} style={{ backgroundImage: `url(${bg})`, backgroundRepeat: 'no-repeat', }} >
            ...
            <div id="about" className={classes.bungkus}>
                ...
                <h1 className={classes.nama}>Frinaldo Sinaga</h1>
                <p className={classes.deskripsi}>Hello! I am Frinaldo Sinaga. Now I study at ITERA. I want to become a frontend developer. I have passion to create a web or mobile app. I'm focused, dedicated, hard-working and willing to learn in a changing and challenging environment.</p>
            </div>
        </div >
    )
}
